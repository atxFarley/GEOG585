...
%ogr2ogrPath% -skipfailures -s_srs EPSG:4326 -t_srs EPSG:3857 C:\Users\Farley\iCloudDrive\PSUGIS\GEOG585\termProject\rawData\baselayer\reprojected\TxDOT_City_Boundaries.shp C:\Users\Farley\iCloudDrive\PSUGIS\GEOG585\termProject\TexasCities\TxDOT_City_Boundaries.shp
