...
%ogr2ogrPath% -skipfailures -s_srs EPSG:4326 -t_srs EPSG:3857 C:\Users\Farley\iCloudDrive\PSUGIS\GEOG585\termProject\rawData\baselayer\reprojected\Texas_State_Boundary.shp C:\Users\Farley\iCloudDrive\PSUGIS\GEOG585\termProject\stateBoundary\Texas_State_Boundary.shp
