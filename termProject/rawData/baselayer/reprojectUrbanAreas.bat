...
%ogr2ogrPath% -skipfailures -s_srs EPSG:4326 -t_srs EPSG:3857 C:\Users\Farley\iCloudDrive\PSUGIS\GEOG585\termProject\rawData\baselayer\reprojected\uscb09-urban-areas_tx.shp C:\Users\Farley\iCloudDrive\PSUGIS\GEOG585\termProject\urbanAreas\uscb09-urban-areas_tx.shp
